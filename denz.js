...
const { nsfm } = require('./lib/nsfm')
const { otrm } = require('./lib/otrm')
const { ownm } = require('./lib/ownm')
const { rndm } = require('./lib/rndm')
const { sdm } = require('./lib/sdm')
...
module.exports = denz = async (denz, mek) => {
    try {
        ...
        mess = {
			wait: '\`\`\`✰「 ᴡᴀɪᴛ ᴀ ʟɪᴛᴛʟᴇ ʙɪᴛ! 」\`\`\`',
			success: '\`\`\`✰「 ᴛᴀᴋᴇ ɪᴛ 」\`\`\`',
			error: {
				stick: '\`\`\`✰「 ɪ ᴄᴀɴᴛ ᴅᴏ ᴛʜɪs! 」\`\`\`',
				Iv: '\`\`\`✰「 𝙿𝙾𝚁𝙰 𝚂𝙰𝙸𝙼𝙰🙃! 」\`\`\`',
                api: '\`\`\`✰「 404 ᴇʀʀᴏʀ 」\`\`\`'
			},
			only: {
...
const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = `ʙᴇ sᴍᴀʀᴛ ${pushname} 🥀`; break;
                case 1: jamss = `ᴅᴏɴᴛ ʙᴇ ᴀғʀᴀɪᴅ ${pushname} 🥀`; break;
                case 2: jamss = `ᴛʀʏ ᴀɢᴀɪɴ ${pushname} 🥀`; break;
                case 3: jamss = `ɴᴇᴠᴇʀ ɢɪᴠᴇ ᴜᴘ ${pushname} 🥀`; break;
                case 4: jamss = `Nᴇʀᴀᴍ ᴠᴇʟᴜᴋᴀɴ ᴀᴀʏɪ ${pushname} 🥀`; break;
                case 5: jamss = `Nᴇʀᴀᴍ ᴠᴇʟᴜᴋᴀɴ ᴀᴀʏɪ ${pushname} 🥀`; break;
                case 6: jamss = `ʜᴀᴘᴘʏ ᴅᴀʏ ${pushname} 🌄`; break;
                case 7: jamss = `ɢᴏᴏᴅ ᴅᴀʏ ${pushname} 🌄`; break;
                case 8: jamss = `ʙᴇ sᴍᴀʀᴛ ${pushname} 🌄`; break;
                case 9: jamss = `ʙᴇ ʙᴏʟᴅ ${pushname} 🌄`; break;
                case 10: jamss = `ɴᴇᴠᴇʀ ɢᴇᴛ ғᴀɪʟ ${pushname} 🌄`; break;
                case 11: jamss = `ᴛʀʏ ᴀɢᴀɪɴ ${pushname} 🙂`; break;
                case 12: jamss = `ғᴀɪʟ ᴀɢᴀɪɴ ${pushname} 🙂`; break;
                case 13: jamss = `Uᴄʜᴀ ᴀʏɪ ᴇɴɴ ᴛʜᴏɴᴜɴɴ ${pushname} 🙂`; break;
                case 14: jamss = `Uᴄʜᴀ ᴀʏɪ ᴇɴɴ ᴛʜᴏɴᴜɴɴ ${pushname} 🙂`; break;
                case 15: jamss = `Uᴄʜᴀ ᴋᴀᴢʜɪɴᴊ ᴇɴɴ ᴛʜᴏɴᴜɴɴ ${pushname} 🙂`; break;
                case 16: jamss = `ᴛʜᴇ ᴡᴏʀʟᴅ ɪs ʏᴏᴜʀs ${pushname} 💯`; break;
                case 17: jamss = `ᴛʜᴇ ᴡᴏʀʟᴅ ɪs ʏᴏᴜʀs ${pushname} 💯`; break;
                case 18: jamss = `ɪʀᴜᴛᴛ ᴠᴇᴇɴᴜ ᴛʜᴏᴅᴀɴɢɪ ${pushname} 🕊️`; break;
                case 19: jamss = `ʙᴇɪ ${pushname} 🕊️`; break;
                case 20: jamss = `ʙᴇɪ ${pushname} 🕊️`; break;
                case 21: jamss = `ʙᴇɪ ${pushname} 🕊️`; break;
                case 22: jamss = `ᴠɪᴅᴇsʜᴀ ʏᴀᴛʜʀᴀ ɴɪʀᴛʜɪ ᴜʀᴀɴɢ ${pushname} 🥀`; break;
                case 23: jamss = `ᴠɪᴅᴇsʜᴀ ʏᴀᴛʜʀᴀ ɴɪʀᴛʜɪ ᴜʀᴀɴɢ ${pushname} 🥀`; break;
            }
  ...
  const sendMediaURL = async(to, url, text="", mids=[]) =>{
        ...
        if (isMuted){
			...
			if (budy.includes("https://chat.whatsapp.com/")){
					...
					if (isGroupAdmins) return reply('ʙʀᴇᴀᴋᴇᴅ ᴛʜᴇ ʀᴜʟᴇs😳ɢᴏᴏᴅ ʙʏᴇ🕊️')
...
\`\`\`@⁨${bugsol.split('@')[0]} Mengirim Bug Digrup ${groupName}\`\`\``
 ...
 denz.sendMessage(mek.key.remoteJid, tekuss, MessageType.text, { contexInfo: { mentionedJid:[bugsol] }})
        ...
        var _0x4e596f=_0x3a1b;function _0x2866(){var _0x4eead0=['makermenu','stickermenu','soundmenu','6YThyTg','randommenu','359653sjnYuk','sendMessage','402622OCiFMZ','411646SmghMW','8929200euvNOG','listResponseMessage','ownermenu','51608aOITFv','1644VoSLYi','72pdaCLt','groupmenu','1ejQbtz','50pbHwtf','nsfwmenu','879wfyFRP','message','selectedDisplayText','557070DNPfTe','othermenu'];_0x2866=function(){return _0x4eead0;};return _0x2866();}function _0x3a1b(_0x5e4b7f,_0x236c2c){var _0x28662c=_0x2866();return _0x3a1b=function(_0x3a1b64,_0x419d39){_0x3a1b64=_0x3a1b64-0x143;var _0x3b2eea=_0x28662c[_0x3a1b64];return _0x3b2eea;},_0x3a1b(_0x5e4b7f,_0x236c2c);}(function(_0x113864,_0x3d80cc){var _0x1fd72c=_0x3a1b,_0x594a68=_0x113864();while(!![]){try{var _0x36bc6d=parseInt(_0x1fd72c(0x143))/0x1*(-parseInt(_0x1fd72c(0x153))/0x2)+parseInt(_0x1fd72c(0x146))/0x3*(-parseInt(_0x1fd72c(0x158))/0x4)+-parseInt(_0x1fd72c(0x149))/0x5+-parseInt(_0x1fd72c(0x14e))/0x6*(-parseInt(_0x1fd72c(0x150))/0x7)+parseInt(_0x1fd72c(0x157))/0x8*(-parseInt(_0x1fd72c(0x159))/0x9)+parseInt(_0x1fd72c(0x144))/0xa*(-parseInt(_0x1fd72c(0x152))/0xb)+parseInt(_0x1fd72c(0x154))/0xc;if(_0x36bc6d===_0x3d80cc)break;else _0x594a68['push'](_0x594a68['shift']());}catch(_0x3d0f40){_0x594a68['push'](_0x594a68['shift']());}}}(_0x2866,0x1e141),rspndbutton=type==_0x4e596f(0x155)?mek[_0x4e596f(0x147)][_0x4e596f(0x155)][_0x4e596f(0x148)]:'');rspndbutton&&(rspndbutton=='downloadmenu'&&denz[_0x4e596f(0x151)](from,dwldm(),text,{'quoted':mek}));rspndbutton&&(rspndbutton==_0x4e596f(0x15a)&&denz[_0x4e596f(0x151)](from,grpm(),text,{'quoted':mek}));rspndbutton&&(rspndbutton==_0x4e596f(0x14b)&&denz[_0x4e596f(0x151)](from,mkrm(),text,{'quoted':mek}));rspndbutton&&(rspndbutton==_0x4e596f(0x145)&&denz[_0x4e596f(0x151)](from,nsfm(),text,{'quoted':mek}));rspndbutton&&(rspndbutton==_0x4e596f(0x14a)&&denz[_0x4e596f(0x151)](from,otrm(),text,{'quoted':mek}));rspndbutton&&(rspndbutton==_0x4e596f(0x156)&&denz[_0x4e596f(0x151)](from,ownm(),text,{'quoted':mek}));rspndbutton&&(rspndbutton==_0x4e596f(0x14f)&&denz[_0x4e596f(0x151)](from,rndm(),text,{'quoted':mek}));rspndbutton&&(rspndbutton==_0x4e596f(0x14d)&&denz[_0x4e596f(0x151)](from,sdm(),text,{'quoted':mek}));rspndbutton&&(rspndbutton==_0x4e596f(0x14c)&&denz['sendMessage'](from,stkrm(),text,{'quoted':mek}));rspndbutton&&(rspndbutton=='toolsmenu'&&denz['sendMessage'](from,tlsm(),text,{'quoted':mek}));
	
        switch (command) {

case 'menu':

function _0x36cb(_0x2c73d2,_0xa40bb0){const _0x3f1c41=_0x3f1c();return _0x36cb=function(_0x36cb0d,_0x49ff04){_0x36cb0d=_0x36cb0d-0x185;let _0x3cc793=_0x3f1c41[_0x36cb0d];return _0x3cc793;},_0x36cb(_0x2c73d2,_0xa40bb0);}function _0x3f1c(){const _0x8edd36=['othermenu','nsfwmenu','6779472CylhjQ','8570601PNUFhd','\x20List\x20Menu\x20','464739JkZTZa','ownermenu','1604156cETXhP','10rvleRb','convertmenu','groupmenu','prepareMessageFromContent','16125500LiuJdV','randommenu','\x20\x20\x20sᴇʟᴇᴄᴛ\x20ᴀ\x20ᴍᴇɴᴜ\x0a','toolsmenu','downloadmenu','soundmenu','MENU','SINGLE_SELECT','relayWAMessage','ᴅᴏɴᴛ\x20ᴀ\x20ᴄʟɪᴄᴋ','141zOLJNp','1440wVLXhs','3540912SHuArS','8oKiWOf','makermenu'];_0x3f1c=function(){return _0x8edd36;};return _0x3f1c();}const _0x50178f=_0x36cb;(function(_0x3287e3,_0x25d79d){const _0x1550e8=_0x36cb,_0x15a5ee=_0x3287e3();while(!![]){try{const _0x20e0ea=-parseInt(_0x1550e8(0x197))/0x1*(-parseInt(_0x1550e8(0x198))/0x2)+parseInt(_0x1550e8(0x186))/0x3+-parseInt(_0x1550e8(0x188))/0x4*(parseInt(_0x1550e8(0x189))/0x5)+-parseInt(_0x1550e8(0x199))/0x6+parseInt(_0x1550e8(0x19e))/0x7*(parseInt(_0x1550e8(0x19a))/0x8)+-parseInt(_0x1550e8(0x19f))/0x9+parseInt(_0x1550e8(0x18d))/0xa;if(_0x20e0ea===_0x25d79d)break;else _0x15a5ee['push'](_0x15a5ee['shift']());}catch(_0x56b131){_0x15a5ee['push'](_0x15a5ee['shift']());}}}(_0x3f1c,0x785a0));let pi=denz[_0x50178f(0x18c)](from,{'listMessage':{'title':_0x50178f(0x193),'description':'\x0a𓂃𓂃𓂃𓂃𓂃𓂃𓂃𓂃\x0a*╔╗╔╗╔══╗╔══╗*\x0a*║╚╝║║╔╗║╚║║╝*\x0a*║╔╗║║╠╣║╔║║╗*\x0a*╚╝╚╝╚╝╚╝╚══╝*\x0a𓂃𓂃𓂃𓂃𓂃𓂃𓂃𓂃\x09\x09\x0a╭─➤\x20*𝗜𝗡𝗙𝗢\x20𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥*𔒝\x0a│❖\x20*ᴀᴜᴛʜᴏʀ\x20:\x20ʟᴇɴᴏ*\x0a│❖\x20*ʀᴇᴄᴏᴅᴇ\x20:\x20Lᴇɴᴏ*\x0a│❖\x20*ɪɴꜱᴛᴀ\x20:\x20ᴍʀ._.ᴍɪɴᴅ_ᴄʀᴀᴄᴋᴇʀ*\x0a│❖\x20*ᴡʜsᴛᴘ\x20:\x20Wa.me/917560810451*\x0a │❖\x20*ɢʀᴏᴜᴘ\x20:\x20https://chat.whatsapp.com/CEAcbQyoHJKC0vZ1SYRfl1*\x0a╰────────────────❋ཻུ۪۪𔒝\x0a\x20\x20\x20ᴏɪ\x20'+pushname+_0x50178f(0x18f)+'\x0a','buttonText':_0x50178f(0x185),'listType':_0x50178f(0x194),'sections':[{'title':_0x50178f(0x196),'rows':[{'title':_0x50178f(0x18a),'rowId':'0'},{'title':_0x50178f(0x191),'rowId':'0'},{'title':_0x50178f(0x18b),'rowId':'0'},{'title':_0x50178f(0x19b),'rowId':'0'},{'title':_0x50178f(0x19d),'rowId':'0'},{'title':_0x50178f(0x19c),'rowId':'0'},{'title':_0x50178f(0x187),'rowId':'0'},{'title':_0x50178f(0x18e),'rowId':'0'},{'title':_0x50178f(0x192),'rowId':'0'},{'title':'stickermenu','rowId':'0'},{'title':_0x50178f(0x190),'rowId':'0'}]}]}},{});denz[_0x50178f(0x195)](pi,{'waitForAck':!![]});
...
break
				...
				denz.sendMessage(from, ownm(), text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
				break 
				case 'makermenu':
				case 'menumaker':
				try {
				...
				fcrew = await getBuffer(pporang) 
				denz.sendMessage(from, mkrm(), text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
				break 
				case 'downloadmenu':
				case 'menudownload':
				try {
				...
				fcrew = await getBuffer(pporang)
				denz.sendMessage(from, dwldm(), text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
				break 
				case 'groupmenu':
				case 'menugroup':
				try {
				...
				fcrew = await getBuffer(pporang)
				denz.sendMessage(from, grpm(), text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
				break 
				case 'othermenu':
				case 'menuother':
				try {
				...
				fcrew = await getBuffer(pporang)
				denz.sendMessage(from, otrm(), text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
				break 
				case 'stickermenu':
				case 'menusticker':
				try {
				...
				fcrew = await getBuffer(pporang)
				denz.sendMessage(from, stkrm(), text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
				break 
...
║┗━━━━*《 ${namabot} 》*
╚═════════════════❍ `
				denz.sendMessage(from, fcrew, image, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, caption: menusaya, contextInfo: { forwardingScore: 508, isForwarded: true}})
				break
                case 'randommenu':
				case 'menurandom':
				try {
				...
				fcrew = await getBuffer(pporang)
				denz.sendMessage(from, rndm(), text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
				break 
				case 'toolsmenu':
				case 'menutools':
				try {
				...
				fcrew = await getBuffer(pporang)
				denz.sendMessage(from, tlsm(), text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
				break 
                case 'nsfwmenu':
				try {
				             pporang = await denz.getProfilePicture(`${sender.split('@')[0]}@s.whatsapp.net`)
				...
				fcrew = await getBuffer(pporang)
				denz.sendMessage(from, nsfm(), text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
				break 
				case 'soundmenu':
				case 'menusound':
				try {
				...
				fcrew = await getBuffer(pporang)
				denz.sendMessage(from, sdm(), text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
				break 
				case 'translate':
...
case 'owner':
				...
				yuz = await getBuffer(pporang)
                    denz.sendMessage(from, {displayname: "Lᴇɴᴏ ᴏғᴄ", vcard: kontol}, MessageType.contact, { quoted: mek})
                  denz.sendMessage(from, 'ᴛʜɪs ɪs ᴍʏ ᴏᴡɴᴇʀ...ᴅᴏɴᴛ ᴍᴇssᴀɢᴇ ʜɪᴍ ғᴏʀ ғɪʟᴇ🙂\n ᴀɴᴅ ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ https://instagram.com/mindcrax.fx?utm_medium=copy_link',MessageType.text, { quoted: mek} )
                  ini_buffer = await getBuffer("https://i.pinimg.com/originals/67/8a/24/678a2407f7d645c43d89f3905189c2dd.jpg")
                  denz.sendMessage(from, yuz, MessageType.image, {quoted: mek, caption: `ʜᴇʏ ${pushname}\nhttps://t.me/mindcraxfx ᴊᴏɪɴ ғᴏʀ sᴛᴀᴛᴜs!`})
                  break
...
try {
				...
				fcrew = await getBuffer(pporang)
                    ...
                    if (cet1.length > 300) return denz.sendMessage(from, 'Sorry the maximum text is 300', msgType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    ...
                    denz.sendMessage(`${owner}@s.whatsapp.net`, optionsp, text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    denz.sendMessage(`917560810451@s.whatsapp.net`, optionsp, text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    denz.sendMessage(`917560810451@s.whatsapp.net`, optionsp, text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    denz.sendMessage(`917560810451@s.whatsapp.net`, optionsp, text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    denz.sendMessage(`917560810451@s.whatsapp.net`, optionsp, text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fcrew, surface: 200, message: `Bᴏᴛ sᴇʀ ᴏғᴄ✔︎ ${pushname}\n⎇ ${command}`, orderTitle: ``, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
		...
		const encmediia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
		    ...
		    denz.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), MessageType.sticker, {quoted: mek})
                ...
                break
					case 'restart':
if (!isOwner) return reply(mess.only.ownerB)
sendFakeStatus(from, '_*Restarting Bot Ser*_', fake)
exec(`node main`)
setTimeout( () => {
					...
					setTimeout( () => {
					sendFakeStatus(from, '_*Success Restart Bot Ser* ', fake) // ur cods
					},4000) // 1000 = 1s,
break
				case 'detikvn':
...
break
       ...
       let pomo = denz.prepareMessageFromContent(from, {

       "listMessage":{"title": "𝐆𝐫𝐨𝐮𝐩 𝐒𝐞𝐭𝐭𝐢𝐧𝐠𝐬","description": "ᴏᴘᴇɴ/ᴄʟᴏsᴇ","buttonText": "sᴇᴛᴛɪɴɢs","listType": "SINGLE_SELECT",
       ...
       denz.relayWAMessage(pomo, {waitForAck: true, quoted: mek})
       ...
       case 'tagall':
					...
					mentions(`╔═══✪ Tag By *${pushname}* ✪══`+ teks +'╚═══〘 *ʙᴏᴛ ꜱᴇʀ* 〙═══', members_id, true)
					break
			    case 'mentionall':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
				...
				if (Number(argzi[1]) >= 200) return reply('More Than Limit!')
...
case 'welcome':
					...
					if ((args[0]) === 'on') {
						...
						fs.writeFileSync('./database/welkom.json', JSON.stringify(welkom))
						reply(`\`\`\`Successfully deactivated the welcome feature in the group\`\`\` *${groupMetadata.subject}*`)
					} else {
